...
const distributionData: DistributionItem[] = [
  { label: 'Backlog', count: 32, color: '#94A3B8', icon: '☰', percentage: 25 },
  { label: 'Por hacer', count: 24, color: '#3B82F6', icon: '◻', percentage: 19 },
  { label: 'En progreso', count: 18, color: '#F59E0B', icon: '⟳', percentage: 14 },
  { label: 'En revisión', count: 22, color: '#8B5CF6', icon: '◔', percentage: 17 },
  { label: 'Completado', count: 32, color: '#10B981', icon: '✓', percentage: 25 },
];
  ...
  return (
    <div className="task-distribution">
      <div className="task-distribution__header">
        <h2 className="task-distribution__title" style={{ fontStyle: 'italic' }}>
          Distribución de Tareas
        </h2>
        <button className="task-distribution__settings" aria-label="Configurar">
          ⚙
        </button>
      </div>
